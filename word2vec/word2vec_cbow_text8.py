...
words=read_data('E:/dataset/NLP/text8.zip')
...
with graph.as_default(), tf.device('/cpu:0'):
    ...
    loss = tf.reduce_mean(tf.nn.sampled_softmax_loss(softmax_weights, softmax_biases, train_labels,tf.reduce_sum(embeds, 1), num_sampled, vocabulary_size))
