...
#输入层，name_scope限制命名空间，with下所有的节点都会自动命名为input/xxx的格式
...
writer = tf.summary.FileWriter('E:/ML/.vscode/logs/try',sess.graph) #将训练日志写入到logs文件夹下

config=projector.ProjectorConfig()
embedding=config.embedding.add_summary()
projector.visualize_embedding(writer,config)
...
saver.save(sess,"E:/ML/models/try.ckpt")       
